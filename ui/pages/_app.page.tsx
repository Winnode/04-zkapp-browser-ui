...
// Status
  ...
  return (
	<div className={styles.container}>	
	  <Head>
        <title>DAPP ARSYANOTE MINA</title>
		...
		<main className={styles.main}>
			...
			<div id="footer" style={{display: 'block'}} >	
				...
				<a style={{display: 'block'}} href="https://twitter.com/yepisri" target="_blank" rel="noopener noreferrer" >
						<span className={styles.twIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://discordapp.com/users/1032894440806817852" target="_blank" rel="noopener noreferrer" >
						<span className={styles.dcIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://github.com/arsyanode" target="_blank" rel="noopener noreferrer" >
